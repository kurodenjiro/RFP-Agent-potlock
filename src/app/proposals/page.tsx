    ...
    return(
        <div className="w-full h-full">
            ...
            <div className="flex justify-center items-center">
                <div className="md:max-w-screen-2xl md:px-20 px-5 w-full mt-10 pb-20">
                    ...
                    <div className="mt-10 flex flex-row flex-auto justify-between gap-10">
            ...
            <div className="w-full bg-[#F6F8FA] h-64 mb-14 flex flex-row justify-center md:gap-20 items-center">
