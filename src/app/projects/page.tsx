    ...
    return(
        <div className="w-full h-full">
            ...
            <div className="flex justify-center items-center">
                <div className="md:max-w-screen-2xl md:px-20 w-full md:mt-20 mt-10 pb-20">
                    <div className="bg-slate-200 flex flex-col  items-center justify-center">
                        <div className="flex flex-col gap-5 justify-center items-center mt-[50px] mb-[10px]">
                            ...
                            <p className="text-sm text-center">Lorem ipsum dolor sit amet consectetur. Tortor ac amet imperdiet nam odio varius proin. </p>
                        </div>
                        <div className="flex flex-col md:flex-row justify-center gap-3 my-[20px]">
                           ...
                           <div className="flex gap-2 justify-center">
                               <div className="flex items-center justify-between gap-2 w-[114px] md:w-[143px] h-[40px] border rounded-xl bg-white px-2">
                               ...
                               <div className="flex items-center justify-between gap-2 w-[85px] md:w-[143px] h-[40px] border rounded-xl bg-white px-2">
                                    <div className="flex gap-1">
                                        <span className="text-xs text-gray-400 hidden md:block">Category:</span>
                                        <span className="text-xs text-gray-400"> Bounty</span>
                                    </div>
                                   <img width={14} src="/assets/icon/chevrondown.svg" alt="" />
                               </div>
                               <div className="flex items-center justify-between gap-2 w-[75px] md:w-[143px] h-[40px] border rounded-xl bg-white px-2">
                                    <div className="flex gap-1">
                                        <span className="text-xs text-gray-400 hidden md:block">Stage </span>
                    ...
                    <div className="flex flex-col gap-10 mt-8 px-2 md:px-20">
                        <div className="flex items-center justify-between">
                            <div className="flex gap-2 md:gap-4">
                                <div className="flex gap-1">
                                    <span className="text-sm md:text-xl font-bold">$53,000,00</span>
                                    <span className="text-sm md:text-xl font-thin">Total Awarded</span>
                                </div>
                                <div className="flex gap-1">
                                    <span className="text-sm md:text-xl font-bold">200</span>
                                    <span className="text-sm md:text-xl font-thin">RFPs</span>
                                </div>
                                <div className="flex gap-1">
                                    <span className="text-sm md:text-xl font-bold">400</span>
                                    <span className="text-sm md:text-xl font-thin">Non RFPs</span>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="flex gap-2 flex-row overflow-x-scroll justify-between">
                                <div className="flex flex-col gap-2 w-full md:w-[400px] h-[308px] px-2 py-3 border border-solid rounded-md">
                                ...
                                <div className="w-full md:w-[400px] h-[308px] border border-solid rounded-md">
                    ...
                    <div className="flex p-4 md:p-20 flex-col md:flex-row gap-10">
                        <div className="flex flex-col gap-3">
                            <span className="text-xl font-bold">ALL PROJECT</span>
                            <div className="flex flex-col gap-3">
                                <div className="p-5 flex flex-row w-full md:w-[920px] border border-solid rounded">
                                    ...
                                    <div className="flex flex-row items-center flex-1 justify-between invisible md:visible">
